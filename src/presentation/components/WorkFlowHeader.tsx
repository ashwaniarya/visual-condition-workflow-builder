...
import { openGlobalModal, showGlobalToast } from "@/state/store/globalUiActionsSlice";
import { GLOBAL_TOAST_VARIANTS, GLOBAL_UI_MODAL_TYPES } from "@/shared/constants/globalUi";
...
export default function WorkFlowHeader() {
  ...
  const handleFileInputChange = useCallback(
    ...
    [applyWorkflowFromJsonText, dispatch]
  );
