...
import { GLOBAL_TOAST_VARIANTS } from "@/shared/constants/globalUi";
import type { ClearWorkspaceConfirmModalPayload } from "@/shared/constants/globalUi";
import { setSelection } from "@/state/store/canvasSlice";
import { useAppDispatch } from "@/state/store/hooks";
import { closeGlobalModal, showGlobalToast } from "@/state/store/globalUiActionsSlice";
import { Button, Typography } from "@/design-system/ui";
import { CLEAR_WORKSPACE_CONFIG } from "@/shared/constants/clearWorkspaceConfig";
